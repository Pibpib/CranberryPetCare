...
export const REMINDER_DATABASE_ID = "your_database_id"; // Replace with your database ID
export const REMINDER_COLLECTION_ID = "your_collection_id"; // Replace with your collection ID
